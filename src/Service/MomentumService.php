...
class MomentumService
{
    ...
    public const TICKERS = [
        ...
        'VEUR.AS' => ['name' => 'FTSE Developed Europe', 'role' => 'Aandelen Europa large cap', 'equity' => true, 'cash' => false],
        'IEMA.AS' => ['name' => 'Emerging Markets', 'role' => 'Groei / dollar zwak', 'equity' => true, 'cash' => false],
        'AVEM.DE' => ['name' => 'Avantis Emerging Markets', 'role' => 'Groei / EM value', 'equity' => true, 'cash' => false],
